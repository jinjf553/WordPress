...
if( !class_exists( 'l2h_render_class' ) )
{
  class l2h_render_class extends l2h_render_base_class
  {
    ...
    {
      echo "<input style='color:black' type='text' size='4' disabled='disabled' value='" . $args['val'] . "' />";

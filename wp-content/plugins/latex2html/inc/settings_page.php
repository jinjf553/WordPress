...
<div class='l2h_wrap'>
  ...
  <div class="about-text">
    <p>
<?php
printf( __( 'Thanks for your updating! %s %s is totally rebuild based on the neweast version of wordpress, I hope you will enjoy it!', 'latex2html'), 'LaTeX2HTML', '2.0.0' );
?>
    </p>
  </div>
<?php
...
<h2 class="nav-tab-wrapper">
  ...
  <a href="?page=latex2html&tab=support" class="nav-tab <?php echo $this->active_tab == 'support' ? 'nav-tab-active' : ''; ?>"><?php echo __( 'Support &amp; Credit', 'latex2html'); ?></a><br />
</h2>
<?php
